(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Tribute = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
  ...
  function () {
    ...
    _createClass(Tribute, [{
      ...
      key: "hideMenu",
      value: function hideMenu(done = false) {
        if (this.menu) {
    ...
    _createClass(TributeEvents, [{
      ...
      value: function click(instance, event) {
        ...
        if (tribute.menu && tribute.menu.contains(event.target)) {
          ...
          tribute.hideMenu(true); // TODO: should fire with externalTrigger and target is outside of menu
  ...
  function () {
    ...
    _createClass(TributeRange, [{
      ...
      value: function getDocument() {
        ...
        // console.log(this.tribute.current.element.ownerDocument)
        // console.log('OWNER DOC', this.tribute.current)
        ...
        value: function getWindow() {
          ...
          console.error('Element IFRAME window not found. Falling back to primary Window')
      ...
      value: function positionMenuAtCaret(scrollTo) {
        ...
        if (typeof info !== 'undefined') {
          ...
          if (!this.isContentEditable(context.element)) {
            ...
            // console.log('Content Editable (positionMenuAtCaret)')
    ...
    //   }
      ...
      value: function getTextAreaOrInputUnderlinePosition(element, position, flipped) {
        ...
        console.log('Textarea getCaretPosition')
        ...
        // console.log('shadow textarea', div)
        ...
        var toolbar = $(element).parent().find('.sceditor-toolbar').get(0)
        var toolbarHeight = getComputedStyle(toolbar)['height'];
        // console.log(getComputedStyle(toolbar)['margin-bottom'])
        // var windowLeft = (window.pageXOffset || doc.scrollLeft) - (doc.clientLeft || 0);
        // var windowTop = (window.pageYOffset || doc.scrollTop) - (doc.clientTop || 0);
        //[FIX]
        ...
        console.log({
          'WindowTop: ': windowTop,
          'Page Y OffSet: ': this.getWindowSelection().pageYOffset,
          'Document Scroll Top: ': doc.scrollTop,
          'Doc Client Top: ': doc.clientTop,
          'Span Top Offset: ': span.offsetTop,
          'Textarea Top Border Width: ': computed.borderTopWidth,
          'Font Size:': computed.fontSize,
          'Textarea Scroll Top: ': element.scrollTop,
          'Textarea Boundary Top: ': rect.top
        })
        var coordinates = {
          top: parseInt(toolbarHeight) + span.offsetTop + parseInt(computed.lineHeight) + parseInt(computed.paddingTop) - element.scrollTop,//span.offsetTop + rect.top,
          // left: rect.left + windowLeft + 16
          // top: rect.top + windowTop + span.offsetTop + parseInt(computed.borderTopWidth) + parseInt(computed.fontSize) - element.scrollTop,
          left: 10 + windowLeft + span.offsetLeft + parseInt(computed.borderLeftWidth)
        };
        var windowWidth = window.innerWidth;
        var windowHeight = window.innerHeight;
        //[FIX]
        ...
        if (menuIsOffScreen.bottom) {
          console.log('Menu is off screen bottom')
        ...
        //   console.log('Menu offscreen top')
      ...
      value: function getContentEditableCaretPosition(selectedNodePosition) {
        ...
        //[FIX]
        var windowLeft = (this.getWindowSelection().pageXOffset || doc.scrollLeft) - (doc.clientLeft || 0);
        var windowTop = (this.getWindow().pageYOffset || doc.scrollTop) - (doc.clientTop || 0);

        var coordinates = {
          left: rect.left + windowLeft + 16,
          top:  64 + markerEl.offsetHeight + rect.top//+ rect.top + windowTop
        };
        // console.log('Rect', rect)
        // console.log('Marker Height Offset', markerEl.offsetHeight)
        // console.log('Window', windowTop, doc.scrollTop, doc.clientTop)
        // console.log('Selection', window.pageYOffset)
        // console.log('WindowOffset', this.getWindow())
        // console.log('Coordinates', coordinates)
        // var windowWidth = window.innerWidth;
        // var windowHeight = window.innerHeight;
        //[FIX]
        var windowWidth = this.getWindowSelection().innerWidth;
        var windowHeight = this.getWindow().innerHeight;

        var menuDimensions = this.getMenuDimensions();
        var menuIsOffScreen = this.isMenuOffScreen(coordinates, menuDimensions);
        // console.log('Menu is offscreen?', menuIsOffScreen)
  
        if (menuIsOffScreen.right) {
          console.log('Menu off screen Right')
          coordinates.left = 'auto';
          coordinates.right = windowWidth - rect.left - windowLeft;
        }
        // console.log('MenuContainer', this.tribute.menuContainer)
        // var parentHeight = this.getDocument().body.offsetHeight
        var parentHeight = this.tribute.menuContainer ? this.tribute.menuContainer.offsetHeight : this.getDocument().body.offsetHeight;
  
        // if (menuIsOffScreen.bottom) {
        //   console.log('Menu off screen Bottom')
        //   var parentRect = this.tribute.menuContainer ? this.tribute.menuContainer.getBoundingClientRect() : this.getDocument().body.getBoundingClientRect();
        //   var scrollStillAvailable = parentHeight - (windowHeight - parentRect.top);
        //   coordinates.top = 'auto';
        ...
        menuIsOffScreen = this.isMenuOffScreen(coordinates, menuDimensions);
        // console.log('Checked Again\n menuIsOffScreen', menuIsOffScreen)
        if (menuIsOffScreen.left) {
          console.log('Menu is offscreen Left')
          coordinates.left = windowWidth > menuDimensions.width ? windowLeft + windowWidth - menuDimensions.width : windowLeft;
          delete coordinates.right;
        }
  
        // if (menuIsOffScreen.top) {
        //   console.log('Menu is offscreen Top')
        //   // console.log('WindowHeight', windowHeight)
        //   // console.log('menuDimensions.Height', menuDimensions.height);
        ...
        // console.log('Coordinates again', coordinates)
        return coordinates;
      }
    }, {
      key: "scrollIntoView",
