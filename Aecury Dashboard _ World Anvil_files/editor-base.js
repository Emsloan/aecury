(function ($) {
	...
	function decodeEntities(str) {
		...
		for (var i = 0; i < keys.length; i++) {
			while (str.indexOf(keys[i]) > -1) {
				str = str.replace(keys[i], entities[keys[i]]);
			}
		}
		return str;
	}
	...
	function isInline(elm, includeCodeAsBlock) {
		...
		if (tagName === 'code' || tagName === 'noparse') {
	...
	var _templates = {
		...
		pastetext:
			'<div class="sc-dropdown"><label for="txt">{label}</label> ' +
		...
		table:
			...
			// '<div>' +
			'<h4 class="dropdown-header">Insert Table</h4>' +
			'<div class="float-label-wrapper">' +
			'<input type="number" id="rows" value="2" class="float-label-field" />' +
			'<label for="rows" class="float-label">{rows}</label>' +
			'</div>' +
			'<div class="float-label-wrapper">' +
			'<input type="number" id="cols" value="2" class="float-label-field"  />' +
			'<label for="cols" class="float-label">{cols}</label>' +
			'</div>' +
			'<div class="">' +
			'<label for="header" class="custom-checkbox-wrapper">' +
			...
			'</div>' +
			'<div>' +
			'<input type="button" class="btn btn-primary btn-block" value="{insert}" />' +
			'</div>' +
			'</div>',

		image:
			'<div class="sc-dropdown">' +
			'<h4 class="dropdown-header">Insert Image</h4>' +
			'<div class="float-label-wrapper">' +
			'<input type="text" id="image" dir="ltr" class="float-label-field" required/>' +
			'<label for="image" class="float-label">{url}</label> ' +
			'</div>' +
			'<div class="float-label-wrapper">' +
			'<select id="align" dir="ltr" placeholder="Choose" value="" class="float-label-field" required>' +
			'<option value="" style="display:none;"></option>' +
			'<option value="left">Left</option>' +
			'<option value="center">Center</option>' +
			'<option value="right">Right</option>' +
			'</select>' +
			'<label for="align" class="float-label">{align}</label>' +
			'</div>' +
			'<div class="float-label-wrapper">' +
			'<input type="text" id="width" size="2" dir="ltr" class="float-label-field" required />' +
			'<label for="width" class="float-label">{width}</label>' +
			'</div>' +
			'<div class="">' +
			'<label for="nolink" class="custom-checkbox-wrapper">' +
		...
		link:
			'<div class="sc-dropdown">' +
			'<h4 class="dropdown-header">Insert Link</h4>' +
			'<div class="float-label-wrapper">' +
			'<input type="text" id="link" class="float-label-field" required />' +
			'<label for="link" class="float-label">{url}</label>' +
			'</div>' +
			'<div>' +
			'<label for="newtab" class="custom-checkbox-wrapper">' +
		...
		youtubeMenu:
			'<div class="sc-dropdown">' +
			'<h4 class="dropdown-header">Insert YouTube Video</h4>' +
			'<div class="float-label-wrapper">' +
			'<input type="text" id="link" class="float-label-field" required />' +
			'<label for="link" class="float-label">{label}</label>' +
			'</div>' +
			'<input type="button" class="btn btn-block btn-primary" value="{insert}" />' +
			'</div>',

		youtube:
			'<div data-wa-youtube="1" data-wa-youtube-id="{id}" contenteditable="false">' +
			'<iframe width="560" height="315" frameborder="0" allowfullscreen ' +
			'src="https://www.youtube.com/embed/{id}?wmode=opaque&start={time}" ' +
			'data-youtube-id="{id}" allowfullscreen>' +
			'</iframe>' +
			'</div>',
		spotifyMenu:
			'<div class="sc-dropdown">' +
			'<h4 class="dropdown-header">Insert Spotify Media</h4>' +
			'<div class="float-label-wrapper">' +
			'<input type="text" id="link" class="float-label-field" required />' +
			'<label for="link" class="float-label">{label}</label>' +
			'</div>' +
			...
			'</div>',
		spotify:
			'<div data-wa-spotify="1" data-wa-spotify-id="{id}" data-wa-spotify-type="https" contenteditable="false">' +
			'<iframe width="650" height="380" frameborder="0" allowtransparency="true" ' +
			'src="https://open.spotify.com/embed/{id}">' +
			'</iframe>' +
			'</div>',
		soundcloudMenu:
			'<div class="sc-dropdown">' +
			'<h4 class="dropdown-header">Insert SoundCloud Media</h4>' +
			'<div class="float-label-wrapper">' +
			'<input type="text" id="link" class="float-label-field" required />' +
			'<label for="link" class="float-label">{label}</label>' +
			'</div>' +
			...
			'</div>',
		soundcloud:
			'<div data-wa-soundcloud="1" data-wa-soundcloud-url="{id}" contenteditable="false">' +
			'<iframe width="100%" height="300px" frameborder="0" allow="autoplay" scrolling="no" allowtransparency="true" ' +
			'src="https://w.soundcloud.com/player/?url={id}"&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true">' +
			'</iframe>' +
			'</div>',
		keyval:
			'<div class="sc-dropdown">' +
			'<h4 class="dropdown-header">Insert Key/Value Pair</h4>' +
			'<div class="float-label-wrapper">' +
			'<input type="text" id="key" placeholder="" class="float-label-field" required />' +
			'<label for="key" class="float-label">{key}</label>' +
			'</div>' +

			'<div class="float-label-wrapper">' +
			'<input type="text" id="value" placeholder="" class="float-label-field" required />' +
			'<label for="value" class="float-label">{value}</label>' +
			'</div>' +
			// '<div class="">' +
			'<input type="button" class="btn btn-block btn-primary" value="{insert}" />' +
			// '</div>' +
	...
	var defaultCmds = {
		...
		color: {
			_dropDown: function (editor, caller, callback) {
				var content = createElement('div'),
					html = '<h4 class="dropdown-header">Select Color</h4><div class="color-options">',
			...
			// 	}
			// },
			//tooltip: (isGuildMember && isGuildMember === 1 ? 'Font Color' : 'You must be a guild member to use colors!')
		},
		// END_COMMAND
		...
		table: {
			exec: function (caller) {
				...
				appendChild(content, _tmpl('table', {
					rows: editor._('Rows:'),
					cols: editor._('Cols:'),
					header: editor._('Make First Row Header?'),
					insert: editor._('Insert')
				}, true));

				on(content, 'click', '.btn', function (e) {
					var rows = Number(find(content, '#rows')[0].value),
						cols = Number(find(content, '#cols')[0].value),
						header = find(content, '#header')[0].checked,
						html = '<table>';
		...
		image: {
			_dropDown: function (editor, caller, selected, cb) {
				...
				appendChild(content, _tmpl('image', {
					url: editor._('ID (required):'),
					align: editor._('Align (optional):'),
					width: editor._('Width (optional):'),
					nolink: editor._('No Link (optional):'),
					insert: editor._('Insert')
				}, true));
				...
				on(content, 'click', '.btn', function (e) {
					if (urlInput.value) {
						var escapedValue = escape(urlInput.value)
						// console.log('SELECTED',escapedValue)
						cb(
							escapedValue,
							find(content, '#align')[0].value,
							find(content, '#width')[0].value,
							find(content, '#nolink')[0].checked
						);
					}
			...
			exec: function (caller) {
				...
				defaultCmds.image._dropDown(
					...
					caller,
					'',
					function (url, align$$1, width$$1, nolink$$1) {
						// var attrs  = ' data-wa-format="1"';
						...
						// '<img' + attrs + ' src="#" />'
						// );
						// editor.insert('<img' + attrs + ' src="#" />', false)
						editor.insert('[img' + attrs + ']')

						editor.checkNodeChanged();
					}
				);
			},
		...
		link: {
			_dropDown: function (editor, caller, cb) {
				...
				appendChild(content, _tmpl('link', {
					url: editor._('URL:'),
					newTab: editor._('Open in new tab:'),
					insert: editor._('Insert')
				}, true));

				var linkInput = find(content, '#link')[0];
				// var newTab = find(content, '#newTab')[0];

				function insertUrl(e) {
					if (linkInput.value) {
						cb(linkInput.value, find(content, '#newtab')[0].checked);
					}
				...
				on(content, 'click', '.btn', insertUrl);
			...
			exec: function (caller) {
				...
				defaultCmds.link._dropDown(editor, caller, function (url, newTab, text) {
					...
					// IE doesn't.
					text = editor.getRangeHelper().selectedHtml() || url;

					console.log('NEWTAB', newTab)
					// editor.insert('[url:' + url + ']' + text + '[/url]')
					var html = `<span data-wa-base-url="1" contenteditable="false" data-wa-url-link="${url}" ${newTab ? 'data-wa-url-newtab="1"' : ''}>` +
						`<span class="tag" style="display: inline;">[url:<span contenteditable="true" data-wa-url-location>${url}${newTab ? '|tab' : ''}</span>]</span>` +
						`<span contenteditable="true" data-wa-url-display>${url}</span>` +
						`<span contenteditable="false" class="tag" style="display: inline;">[/url]</span>`;
					editor.wysiwygEditorInsertHtml(html, `</span><span>&zwnj;</span>`)
					// console.log(editor)
				});
			},
		...
		youtube: {
			_dropDown: function (editor, caller, callback) {
				...
				on(content, 'keydown', '.sc-dropdown', function (e) {
					if (e.key === 'Enter') {
						e.preventDefault();
						handler(e)
					}
		...
		//START_COMMAND: Spotify
		spotify: {
			_dropDown: function (editor, caller, callback) {
				var content = createElement('div');

				appendChild(content, _tmpl('spotifyMenu', {
					label: editor._('Spotify URL:'),
					insert: editor._('Insert')
				}, true));
				var handler = function (e) {
					var val = find(content, '#link')[0].value;
					var idMatch = val.match(/(?:spotify\.com\/|embed\/)(.*)/);
					console.log('here', idMatch)
			...
			exec: function (btn) {
				var editor = this;
				defaultCmds.spotify._dropDown(editor, btn, function (id) {
					console.log(id)
					editor.wysiwygEditorInsertHtml(_tmpl('spotify', {
						id: id
					}));
				});
			},
			tooltip: 'Insert Spotify Media'
		},
		//START_COMMAND: Soundcloud
		soundcloud: {
			_dropDown: function (editor, caller, callback) {
				var content = createElement('div');

				appendChild(content, _tmpl('soundcloudMenu', {
					label: editor._('SoundCloud URL:'),
					insert: editor._('Insert')
				}, true));
				var handler = function (e) {
					var val = find(content, '#link')[0].value;

					console.log('soundcloud val', val)
					// var idMatch = val.match(/(?:spotify\.com\/|embed\/)(.*)/);
					callback(val)
					editor.closeDropDown(true);
					e.preventDefault();
			...
			exec: function (btn) {
				var editor = this;
				console.log('soundcloud exec')
				defaultCmds.soundcloud._dropDown(editor, btn, function (id) {
					editor.wysiwygEditorInsertHtml(_tmpl('soundcloud', {
						id: id
					}));
				});
			},
			tooltip: 'Insert SoundCloud Media'
		},
		// END_COMMAND
		...
		keyval: {
			exec: function (caller) {
				...
				appendChild(content, _tmpl('keyval', {
					key: editor._('Key'),
					value: editor._('Value'),
					insert: editor._('Insert')
				}, true));
				var handler = function (e) {
					var key = find(content, '#key')[0].value,
						value = find(content, '#value')[0].value,
						html = ''

					if (key && value) {
						html += '<div data-wa-keyval="1" data-wa-keyval-key="' + key + '" data-wa-keyval-val="' + value + '">' +
							'<strong class="phrase-key">' + key + '</strong><br/>' +
							'<span class="phrase-value">' + value + '</span>' +
							'</div><span>&zwnj;</span>';
						editor.wysiwygEditorInsertHtml(html);
						editor.closeDropDown(true);
						e.preventDefault();
						editor.focus();
						var helper = editor.getRangeHelper();
						var selected = helper.selectedRange();
						var newline = $('.sceditor-nlf').get(0);
						if (!newline) {
							setTimeout(function () {
								newline = $('.sceditor-nlf').get(0);
								console.log(newline)
							}, 700)
						}
				...
				editor.createDropDown(caller, 'keyval', content);
			},
			tooltip: 'Insert Key/Value group'
		},
	...
	function replace(root, emoticons, emoticonsCompat) {
		...
		if (parent(root, 'code') || parent(root, 'noparse')) {
			return;
		}
		...
		(function convert(node) {
			...
			while (node) {
				// TODO: Make this tag configurable.
				if (node.nodeType === ELEMENT_NODE && !is(node, 'code') && !is(node, 'noparse')) {
					convert(node);
				}
	...
	function SCEditor(original, userOptions) {
		...
		initEditor = function () {
			...
			base.val(decodeEntities(original.innerHTML));
		...
		initEvents = function () {
			...
			// 	console.log('attempting to trigger autosave!')
			// 	base.updateOriginal();
			// 	var saveBtnEl = $('.force-save')[0];
			// 	if (saveBtnEl) {
			// 		saveBtnEl.click();
			// 	}
			// }
			...
			on(wysiwygBody, 'keyup', debounce(base.handleAutoSave, options.autoSaveDelay));
			on(sourceEditor, 'keyup', debounce(base.handleAutoSave, options.autoSaveDelay));
			on(wysiwygBody, 'blur', valueChangedBlur);
			// on(wysiwygBody, 'blur', debounce(handleAutoSave, options.autoSaveDelay));
			on(wysiwygBody, 'keyup', valueChangedKeyUp);
			on(wysiwygBody, 'paste', handlePasteEvt);
			on(wysiwygBody, 'paste', debounce(base.handleAutoSave, options.autoSaveDelay));
			on(sourceEditor, 'paste', debounce(base.handleAutoSave, options.autoSaveDelay));
		...
		initToolBar = function () {
			var group,
				...
				secondaryGroups = options.secondaryToolbar.split('|');

			toolbar = createElement('div', {
				className: 'sceditor-toolbar',
				unselectable: 'on'
			});
			var secondaryToolbar = createElement('div', {
				className: 'sceditor-toolbar secondary-toolbar',
				unselectable: 'on',
				style: 'display: none;'
			});
			...
			each(secondaryGroups, function (_, menuItems) {
				...
				each(menuItems.split(','), function (_, commandName) {
					...
					on(button, 'click', function (e) {
						console.log('A button was clicked!', commandName)
						if (!hasClass(button, 'disabled')) {
							handleCommand(button, command);
							var ignoredCommandNames = ['youtube', 'spotify', 'soundcloud'];
							if (!ignoredCommandNames.includes(commandName)) {
								base.handleAutoSave();
							}
					...
					if (command.tooltip) {
						...
						attr(button, 'data-toggle', 'tooltip');
					}
				...
				if (group.firstChild) {
					appendChild(secondaryToolbar, group);
				}
			});

			// console.log("Excluded: ", commands)
			each(groups, function (_, menuItems) {
				...
				each(menuItems.split(','), function (_, commandName) {
					...
					// console.log(commandName)
					// console.log('Shortcut to add', command)
					button = _tmpl('toolbarButton', {
						name: commandName,
					...
					toggleClass(button, 'disabled', !command.exec);
					on(button, 'click', function (e) {
						console.log('button clicked', commandName)
						if (!hasClass(button, 'disabled')) {
							handleCommand(button, command);
							var ignoredCommandNames = ['source', 'maximize', 'image', 'color', 'link', 'toggleToolbar'];
							if (!ignoredCommandNames.includes(commandName)) {
								base.handleAutoSave();
							}
						}
			...
			appendChild(options.toolbarContainer || editorContainer, secondaryToolbar);
		};
		...
		initResize = function () {
			...
			grip.innerHTML = '<i class="fal fa-chevron-double-down"></i>';
		...
		base.createDropDown = function (menuItem, name, content, ieFix) {
			...
			if ($(parent).hasClass('secondary-toolbar')) {
				dropDownCss = extend({
					top: menuItem.offsetTop,
					left: menuItem.offsetLeft + 2,
					marginTop: parent.offsetTop + menuItem.clientHeight
				}, options.dropDownCss);
			} else {
				dropDownCss = extend({
					top: menuItem.offsetTop,
		...
		base.wysiwygEditorInsertHtml = function (
			...
			if (!overrideCodeBlocking && (closest(currentBlockNode, 'code') || closest(currentBlockNode, 'noparse'))) {
				return;
			}
		...
		base.updateOriginal = function () {
			...
			// console.log('updating original textarea: (using jquery)', saveBtnEl)
		};

		base.handleAutoSave = function() {
			console.log('attempting to trigger autosave!')
			base.updateOriginal();
			var saveBtnEl = $('.force-save')[0];
			if (saveBtnEl) {
		...
		base.toggleSourceMode = function () {
			...
			if (isInSourceMode) {
				var html = base.getSourceEditorValue();
				// console.log('Leaving Source Mode', html)
				base.setWysiwygEditorValue(html);
			} else {
				var content = base.getWysiwygEditorValue();
				// console.log('Entering Source Mode', content)
				base.setSourceEditorValue(content);
			}
		...
		base.execCommand = function (command, param) {
			...
			if (closest(rangeHelper.parentNode(), 'code') || closest(rangeHelper.parentNode(), 'noparse')) {
				return;
			}
		...
		base.checkNodeChanged = checkNodeChanged;
		...
		emoticonsKeyPress = function (e) {
			...
			// TODO: Make configurable
			if (closest(currentBlockNode, 'code') || closest(currentBlockNode, 'noparse')) {
				return;
			}
		...
		handleKeyDown = function (e) {
			...
			// console.log('Shortcuts: ', shortcutHandlers)
			shortcut = shortcut.join('+');
			if (shortcutHandlers[shortcut] &&
				shortcutHandlers[shortcut].call(base) === false) {
				// console.log('Shortcut "' + shortcut + '" executed.')
				e.cancelBubble = true;
				e.stopPropagation();
				e.preventDefault();
				return false
			...
			if (which === 8) {
				...
				if (!base.inSourceMode()) {
					...
					var rangeHelper = base.getRangeHelper();
					var selectedRange = rangeHelper.selectedRange();
					var firstParent = rangeHelper.parentNode();
					var html = rangeHelper.selectedHtml();
					// console.log(html)
					if (html.length > 0) {
						...
						try {
							selectedRange.setStart(selectedRange.endContainer, selectedRange.startOffset - 1); //Select the Article
							html = rangeHelper.selectedHtml();
							// console.log(html)
							if (html.match(/\u200c/)) {
								// console.log('Match')
								html = selectedRange.endContainer.parentNode.previousSibling;
								selectedRange.selectNode(html)
								// html = html.previousSibling;
								// console.log(html, typeof html)
								// console.log(rangeHelper.selectedHtml())
								e.preventDefault();
								return
							}
							// console.log(html)
							if (html && html !== '&nbsp;') {
								var sibling = $(html).get(0);

								if (sibling) {
									if (sibling.getAttribute('data-wa-article') === "1") {
										e.preventDefault();
										// selectedRange.deleteContents();
										return;
									}
									if (sibling.getAttribute('data-wa-base-url') === '1') {
										e.preventDefault();
										return;
									}
									if (sibling.getAttribute('data-wa-custom-br') === '1') {
										e.preventDefault();
										return;
									}
									if (sibling.getAttribute('data-wa-keyval') === "1") {
										e.preventDefault();
										return;
									}
								}
			...
			// header escaping
			if (which === 13 && !base.inSourceMode()) {
				console.log('Enter Pressed')
				// console.log($('.tribute-container').css('display'))
				if ($('.tribute-container').css('display') === 'block') {
					return;
				}
				var rangeHelper = base.getRangeHelper();
				var parentNode = rangeHelper.getFirstBlockParent();
				if (headers.indexOf(parentNode.nodeName) > -1) {
					e.preventDefault();
					e.stopPropagation();
					//create div
					var body = base.getBody();
					var doc = body.ownerDocument;
					var sel = wysiwygWindow.getSelection();
					var div = doc.createElement('div');
					div.innerText = "\u00a0";
					div.setAttribute('newMarker', true);

					//insert div after header
					$(div).insertAfter($(parentNode))
					//select div
					...
					if ($('.tribute-container').css('display') !== 'none') {
						// console.log($('.tribute-container'))
						return;
					}
					// console.log(parentNode)
					if (parentNode.getAttribute('data-wa-container')) {
						return;
					}
					if (!base.inSourceMode() && parentNode.nodeName === 'DIV') {
						e.preventDefault();
						e.stopPropagation();
						//create div
						var body = base.getBody();
...
(function (sceditor) {
	...
	var defaultCommandsOverrides = {
		...
		link: {
			txtExec: function (caller, selected) {
				...
				getEditorCommand('link')._dropDown(
					editor,
					caller,
					function (url, text, newTab) {
						console.log('LINK TEXTMODE', newTab)
						editor.insertText(
							'[url:' + url + ']' +
							(text || selected || url) +
							'[/url]'
		...
		youtube: {
			txtExec: function (caller) {
				...
				getEditorCommand('youtube')._dropDown(
					...
					caller,
					function (id) {
						editor.insertText('[youtube:https://youtube.com/watch?v=' + id + ']');
					}
				);
			}
		},
		spotify: {
			txtExec: function (caller) {
				var editor = this;
				getEditorCommand('spotify')._dropDown(
					editor,
					caller,
					function (id) {
						editor.insertText('[spotify:' + id + ']');
					}
				)
			}
		},
		soundcloud: {
			txtExec: function (caller) {
				var editor = this;
				getEditorCommand('soundcloud')._dropDown(
					editor,
					caller,
					function (id) {
						editor.insertText('[soundcloud:' + id + ']');
					}
				)
			}
		},
	...
	function BBCodeParser(options) {
		...
		function normaliseNewLines(children, parent, onlyRemoveBreakAfter) {
			...
			while (i--) {
				// console.log('TOKEN', children[1])
				if (!(token = children[i])) {
					continue;
				}
				// console.log('TOKEN 9277', token)
