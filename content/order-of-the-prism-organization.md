...
Leader: "[[Trinoa Zakharov]]"
Leadertitle: "[[Apex Lux]]"
Deities: "[[Amaunator]]"
Motto: "Expelle Tenebris (expel the darkness)"
Assets: "The Order has a modest treasury, a keep, and a massive library. They also posses a trove of artifacts and inventions found and created by their members throughout the years."
Structure: |
  An order equal parts knightly and scholastic. The major structure is a system of ranks, each rank being associated with a color of the rainbow. The ranks are as follows:
  [ol]
  [li][b]Page [/b](red) [i]levels 1-2[/i][/li]
  [li][b]Squire [/b](orange) [i]levels 3-4[/i][/li]
  [li][b]Knight Aspirant[/b] (yellow) [i]levels 5-7[/i][/li]
  [li][b]Knight Postulant [/b](green) [i]levels 8-9[/i][/li]
  [li][b]Knight Adept[/b] (cyan) [i]levels 10-11[/i][/li]
  [li][b]Knight Savant[/b] (blue) [i]levels 12-13[/i][/li]
  [li][b]Knight Maven[/b] (violet) [i]levels 14+[/i][/li]
  [/ol]
  [quote]
  [i]Surely the prism is a divine implement. See how it reveals the secrets hidden in light? From the urbane red, the colour of blood and wine, down to esoteric violet, rarest of all.[/i][/quote]
FoundingDate: "2412"
wip: true
---
...
> Without obstruction, a ray of light continues straightly, unbent until it reaches its conclusion. The method of one's scholarly pursuits shall be like the ray.
> The brightness of a flame is relative to the illumination of its surroundings. Amaunator's light outshines all others.
> Knowledge is the flame that must be preserved. It needs innovation to fuel it and freedom to burn
